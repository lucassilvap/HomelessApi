...
public abstract class HomelessSpecification {
	...
	public static Specification<HomelessPersonEntity> spec(Optional<String> partName, Optional<String> currentSituation, Optional<Integer> age, Optional<List<Integer>> ageBetween){
